...
const ExpenseApp=()=>{
    ...
    useEffect(()=>{
        if (!searchVal || searchVal ===''){
            ...
            const filteredValue= transactionsList.filter(item=>item.desc.toLowerCase().includes(searchVal.toLowerCase()))
...
return(
    <div>
        ...
        <div className="App">
        <Overview expense={expense} income={income} transactionShow={transactionShow}  setTransactionShow={setTransactionShow}/>
        {
            transactionShow && <Transaction  addTransaction={addTransaction} setTransactionShow={setTransactionShow}/>
        }
       
       
        <TransactionList filteredVal={filteredVal} setTransaction={setTransaction} setFilteredVal={setFilteredVal} transaction={transaction} handleEdit={handleEdit} submitEdit={submitEdit}/>
        </div>
